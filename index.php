...
$arreyFaqs = [
    ...
    [
        ...
        "answer" => "l tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:<br><br>
        <ol>
        ...
        "subanswer" => "Quando crei un nuovo Account Google, lo associamo a un paese in base a dove è stato creato. Per quanto riguarda gli account creati almeno un anno fa, usiamo il paese da cui accedi solitamente ai servizi Google, in genere i servizi in cui hai trascorso più tempo nell'ultimo anno.<br>
...
<body>
    <header>
        <div class="logo">
            <img class="logo-google" src="./img/google_logo.png" alt="">
        ...
        <div class="menu">
            <nav>
                <ul>
                    ...
                    <li class="active"><a class="text-active" href="#">Domande frequenti</a></li>
                </ul>
            </nav>
            <hr>
        </div>
    ...
    <main>
        <div class="container-main">
            <?php
                foreach ($arreyFaqs as $key => $domanda) {
                    echo "<h1>" .  $domanda['question'] . "</h1><br>";
                    echo "<h3>" .  $domanda['answer'] . "</h3>";
                    echo "<br><br>";
                }
            ?>
        </div>
